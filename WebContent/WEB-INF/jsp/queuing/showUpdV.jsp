...
<html>
	...
	$(function(){
		...
		$('#remarks').change(function(){
			var remarksid=$(this).children('option:selected').val()
			if(remarksid!=""){
				document.getElementById("remarksColor").style.color="green";
				document.getElementById("remarksColor").innerText="√";
			}
  ...
  <tr valign="top">
    <td>
    	 <form action="${ctx}/queuingV/updateVipAck" id="VipUpdForm" method="post">
    	 	...
    	 	<input type="hidden" name="vid" value="${updateV.vid}">
		    	...
		    	<table>
		    		...
		    		<td>
		    				<select name="remarks" id="remarks">
								<option disabled="disabled" selected="selected">-请选添加原因-</option>
								<option value="重要急件" >重要急件</option>
								<option value="人员调控" >人员调控</option>
							</select>
		    		</td>
		    		<td><font id="remarksColor" color="red">*必选&nbsp;</font></td>
		    		</tr>
