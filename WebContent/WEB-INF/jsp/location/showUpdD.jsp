...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/driver/upDriverAck" id="driverForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    			...
		    			<input name="vehicleCode" id="floorNumber" type="hidden" value="${entity.vehicleCode}" size="20"/>
		    			${entity.vehicleCode}
		    			</td>
		    			</tr>
		    		<tr>
		    			<td class="font3 fftd">车主&nbsp;名称：&nbsp;
		    			<input name="name" id="elevatorName" type="text" value="${entity.name}" size="20"/></td>
		    		</tr>
		    		
		    		<tr>
		    			<td class="font3 fftd">车辆&nbsp;类型：&nbsp;
		    			<input name="cartType" id="controllerSN" type="text" value="${entity.cartType}"  size="20"/></td>
		    		</tr>
		    		...
		    		<tr>
		    			...
		    			<input class="Wdate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'});" 
							name="optdate" id="optdate" value="<fmt:formatDate value="${entity.optdate}" pattern="yyyy-MM-dd HH:mm:ss"/>"  size="20" />
						</td>
		    		</tr>
		    	</table>
		    </td></tr>
			...
			<tr><td align="left" class="fftd"><input type="button" id="addD" value="&nbsp;&nbsp;修改&nbsp;&nbsp;">&nbsp;&nbsp;<input type="button" onclick="javascript:window.history.back(-1);" value="&nbsp;&nbsp;返回 &nbsp;&nbsp;"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
