...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
	...
	<tr>
		...
		<td class="font3 fftd">过期时间：&nbsp;<input cssClass="Wdate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'});"name="overduetime" value="${getUpdate.overduetime }" id="overduetime" size="20"/>&nbsp;&nbsp;</td>
	</tr>
	<tr>
