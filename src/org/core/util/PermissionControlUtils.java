...
public class PermissionControlUtils {
	 ...
	 * @param list
	 */
	public static void batchAcAuth(List<Map<String, Object>> mjList , List<Map<String, Object>> dtList){
		 ...
		 * 电梯下发权限
		 */
//		LadderControlUtil.LadderControlUserCard((Long) map.get("controllerSN"), (String) map.get("ip"), (Long) map.get("cardNO"),1,(byte)0x20,(byte)0x29,(byte)0x12,(byte)0x31,
